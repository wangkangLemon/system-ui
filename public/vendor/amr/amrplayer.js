...
* */
window.AmrPlayer = function(download_success_cb, download_progress_cb){
    this.init(download_success_cb, download_progress_cb);
};
AmrPlayer.prototype = {
    init: function(){
    ...
    playAmr: function(amr_url,download_success_cb, download_progress_cb) {
