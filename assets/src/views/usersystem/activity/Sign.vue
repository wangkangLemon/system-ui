        ...
        <el-card class="box-card">
            ...
            <el-table
                ...
                <el-table-column
                        ...
                        >
                        <template scope="scope">
                            <el-button type="text" @click="$router.push({name:'activity-prize', params:{play_type:'sign_month',id:scope.row.id,product_name:scope.row.product_name} })">{{scope.row.left}}</el-button>
                        </template>
                </el-table-column>
        ...
        <el-card class="box-card">
            ...
            <el-table
                ...
                <el-table-column
                        ...
                        label="已发放">
                        <template scope="scope">
                            <el-button type="text" @click="$router.push({name:'activity-prize', params:{play_type:'sign_weekly',id:scope.row.id,product_name:scope.row.product_name} })">{{scope.row.left}}</el-button>
                        </template>
                </el-table-column>
                <el-table-column
                        prop="operate"
