...
<template>
<article id="activity-details-container">
...
<script>
import detailsService from '../../../services/usersystem/detailsService'
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.loading = true
            return detailsService.getAll(this.fetchParam).then((ret) => {
        ...
        export() {
            return detailsService.export(this.fetchParam)
        },
