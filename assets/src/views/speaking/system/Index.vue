    ...
    <article class="speaking-system-container">
        ...
        <article class="tab-container">
            <section class="search">
                ...
                <section v-if="type == 1">
                    <i>连锁</i>
                    <IndustrySelect :type="2" v-model="search.company_id"
            ...
            <el-table v-if="type == 0 || type == 1 || type == 2" :data="tableData" border v-loading="loading">
                <el-table-column v-if="type == 0" label="标题" prop="title" min-width="180">
                    <el-button type="text"
                               @click="$router.push({name: 'speaking-system-index', query: {type: 1, id: scope.row.id}})"></el-button>
                </el-table-column>
                <el-table-column v-if="type == 1 || type == 2" :label="type == 1 ? '连锁' : '门店'" prop="title" min-width="180">
                    <el-button type="text"
                               @click="$router.push({name: 'speaking-system-index', query: {type: type+1, id: scope.row.id}})"></el-button>
                </el-table-column>
                <el-table-column v-if="type == 1 || type == 2" label="未练习人数" prop="title" width="120"></el-table-column>
                <el-table-column label="练习人数" prop="testing" width="100"></el-table-column>
                <el-table-column label="练习次数" prop="no-testing" width="120"></el-table-column>
            ...
            <el-table v-if="type == 3" :data="tableData" border v-loading="loading">
                1
                <el-table-column label="员工姓名" prop="title" width="120"></el-table-column>
                <el-table-column label="职务" prop="testing" width="100"></el-table-column>
                <el-table-column label="门店" prop="no-testing" min-width="180"></el-table-column>
                <el-table-column label="练习次数" prop="times" width="100"></el-table-column>
                <el-table-column label="最高分数" prop="score" width="100"></el-table-column>
            </el-table>
...
//                this.loading = true
//                let p
//                if (this.type == 0) p = speakingService.getData()
//                else if (this.type == 1) p = speakingService.getData()
//                else if (this.type == 3) p = speakingService.getData()
//                else p = speakingService.getData()
//
//                p.then((ret) => {
