	...
	<article class="company-admin-container">
		...
		<el-dialog :visible.sync="addForm">
			<el-form :model="form" :rules="rules" ref="form">
				<el-form-item v-if="category == 2" prop="department_id" label="门店" :label-width="formLabelWidth">
					<departmentSelect :type="companyID" v-model="form.department_id" v-on:change="val=>form.department_id = val">
					</departmentSelect>
				</el-form-item>
		...
		<div class="main-container">
			...
			<el-table border v-loading="loading" :data="adminData">
				...
				<el-table-column prop="last_login_time_name" label="上次登录时间" width="200">
				</el-table-column>
				<el-table-column prop="last_login_ip" label="上次登录IP" width="200">
				</el-table-column>
