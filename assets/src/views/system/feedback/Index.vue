    ...
    <article class="system-manage">
        ...
        <el-dialog title="查看详情" class="show-detail" v-model="showDetail">
            <div class="info" v-if="detail != null">
                ...
                <p><i class="title">企业名称：</i><span class="value">{{detail.company_name}}</span></p>
                <p><i class="title">门店：</i><span class="value">{{detail.department_name}}</span></p>
                ...
                <p class="question">
                    ...
                    <span class="value">
                        <div class="img-wrap">
                            <img :src="item | fillImgPath" alt="" v-for="item in detail.upload_group" @click="screenImg(item)">
                            <!--示例-->
